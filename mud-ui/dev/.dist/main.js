...
var DARK_INK = { r: 15, g: 17, b: 21 };
var LIGHT_INK = { r: 255, g: 255, b: 255 };
var themeTargets = /* @__PURE__ */ new Set();
var themeObserver = null;
var themeListenersBound = false;
var controller = null;
var lastAnchor = null;
var clamp = (value, min = 0, max = 255) => Math.min(max, Math.max(min, Number.isFinite(value) ? value : 0));
...
var pickInk = (color) => relativeLuminance(color) > 0.55 ? DARK_INK : LIGHT_INK;
...
var ensureReadable = (color, background, reference, minRatio = 4.5) => {
...
function computePalette() {
  ...
  const accent = parseColor(style.getPropertyValue("--accent")) || parseColor(style.getPropertyValue("--primary-color")) || FALLBACK.accent;
...
var MudOverlay = forwardRef(function MudOverlay2({ initialUrl = "", deferConnect = false, container, onRequestClose }, ref) {
  ...
  const grpBufRef = useRef([]);
  const grpClsRef = useRef(null);
  const grpStampRef = useRef(null);
  const grpTimerRef = useRef(null);
  const msgIdRef = useRef(0);
  const lastActionRef = useRef(0);
  const trimMessages = useCallback((list) => {
  ...
  const setStatus = useCallback((txt, state) => {
    setStatusText(txt);
    setStatusMode(state);
  }, []);
  ...
  const updateStatus = useCallback((stateMsg) => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs("div", { className: "head", children: [
      /* @__PURE__ */ jsxs("span", { className: statusClass, role: "status", "aria-live": "polite", children: [
        "\u25CF ",
        statusText
      ] }),
      /* @__PURE__ */ jsx(
    ...
    /* @__PURE__ */ jsxs("div", { className: "status-panel", style: { display: statusVisible ? "flex" : "none" }, children: [
      /* @__PURE__ */ jsxs("div", { className: "health-container", children: [
        /* @__PURE__ */ jsxs("span", { className: "health-text", children: [
          "HP: ",
          health ? `${health.current}/${health.max}` : "--/--"
        ] }),
        /* @__PURE__ */ jsx("div", { className: "health-bar-bg", children: /* @__PURE__ */ jsx("div", { className: "health-bar", style: { width: `${hpPercent}%`, backgroundColor: healthColor } }) })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "level-container", children: [
        /* @__PURE__ */ jsx("span", { className: "level-text", children: level != null ? `Level ${level}` : "Level --" }),
        /* @__PURE__ */ jsx("div", { className: "xp-bar-bg", children: /* @__PURE__ */ jsx("div", { className: "xp-bar", style: { width: `${xpPercent}%` } }) })
      ] }),
      /* @__PURE__ */ jsx("span", { className: "area-text", children: area ? `\u{1F4CD} ${area}` : "" }),
      /* @__PURE__ */ jsx("span", { className: "effects-text", children: effects.length ? `\u2728 ${effects.map((e) => {
        const [name, bonus] = e.split(":");
        return bonus ? `${name} (+${bonus} HP)` : name;
      }).join(", ")}` : "" })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "out", ref: outRef, children: messages.map((msg) => {
      if (msg.kind === "gap") return /* @__PURE__ */ jsx("div", { className: "gap" }, msg.id);
      const classes = ["line"];
      ...
      return /* @__PURE__ */ jsxs("div", { className: classes.join(" "), children: [
        /* @__PURE__ */ jsx("div", { className: "ts", children: msg.ts }),
        /* @__PURE__ */ jsx("div", { className: `msg ${msg.cls}`, children: msg.text })
      ] }, msg.id);
    }) }),
    /* @__PURE__ */ jsxs("div", { className: "in", children: [
      /* @__PURE__ */ jsx(
        "textarea",
        {
          ref: inputRef,
      ...
      /* @__PURE__ */ jsx("button", { className: "btn btn-primary", type: "button", onClick: send, children: "Send" }),
      /* @__PURE__ */ jsx(
        "button",
        {
...
function buildController(root, options) {
  const pending = [];
  let api = null;
...
document.addEventListener(
  "mud:spawn",
  (e) => spawnMudOverlay(e?.detail?.url, e?.detail?.anchor ? { anchor: e.detail.anchor } : void 0),
  { passive: true }
);
...
createRoot(el).render(
  /* @__PURE__ */ jsx(
    "button",
    {
      ...
      onClick: () => window.spawnMudOverlay?.("ws://localhost:8080", { deferConnect: false }),
      children: "Launch Mud Overlay"
    }
  )
);
